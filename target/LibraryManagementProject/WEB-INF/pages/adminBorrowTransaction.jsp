...
<div class="container">
    <div class="jumbotron">
        <h1> 预约处理 </h1>
        <hr/>
        <c:if test="${!empty borrowEntitiesToBeDone}">
            <table class="table table-bordered table-striped">
                ...
                <c:forEach items="${borrowEntitiesToBeDone}" var="transaction">
                    <tr>
                        <td>${transaction.readerNo}</td>
                        <td>${transaction.bookNo}</td>
                        <td>
                            <form:form action="/admin/borrow-agree" method="post">
                                <button type="submit"class="btn btn-sm btn-success"> 同意借阅请求 </button>
                                <input type="hidden" name="bookNo" value=${transaction.bookNo}>
                                <input type="hidden" name="readerNo" value=${transaction.readerNo}>
                            </form:form>
                        </td>
                    </tr>
